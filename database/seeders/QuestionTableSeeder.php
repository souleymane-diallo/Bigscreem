...
class QuestionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $question = [
            ...
            [ 'title'=>'Question 8/20','body'=>'Quel casque envisagez-vous d’acheter dans un futur proche  ?','type'=>'A','possible_answer'=>'Occulus Quest,Occulus Go,HTC Vive Pro,PSVR,Autre,Aucun','check_email'=>false,'survey_id'=>1],
